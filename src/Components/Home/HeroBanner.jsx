        ...
        <section className="bg-[#f3faff] p-20 border-t-2 border-t-gray-200 relative">
            <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center px-4">
                ...
                <motion.div
                    ...
                    className="lg:w-1/2"
                >
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 transition-colors duration-300 hover:text-rose-600">
                    ...
                    <a
                        href="#get-started"
                        className="inline-block bg-rose-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 hover:scale-105 transform transition duration-300 shadow-md hover:shadow-lg"
                    >
                        Get Started
                    </a>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="lg:w-1/2 mb-10 lg:mb-0 cursor-pointer"
                >
